...
import { DataTableSummaryRowCellComponent } from '.';
...
describe('DataTableBodyCellComponent', () => {
    let fixture: ComponentFixture<DataTableSummaryRowCellComponent>;
    let component: DataTableSummaryRowCellComponent;
    let element;
    ...
    beforeEach(async(() => {
        TestBed.compileComponents().then(() => {
            fixture = TestBed.createComponent(DataTableSummaryRowCellComponent);
