...
__decorate([
    core_1.Input(),
    __metadata("design:type", Number)
], ScrollerComponent.prototype, "actualWith", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", core_1.EventEmitter)
...
var types_1 = __webpack_require__("./src/types/index.ts");
var utils_1 = __webpack_require__("./src/utils/index.ts");
var scrollbar_helper_service_1 = __webpack_require__("./src/services/scrollbar-helper.service.ts");
var DataTableHeaderComponent = (function () {
    ...
    DataTableHeaderComponent.prototype.stylesByGroup = function (group) {
        ...
        if (group === 'center') {
            ...
            var offset = (totalDiff + this.scrollbarHelper.width) * -1;
            utils_1.translateXY(styles, offset, 0);
        }
        return styles;
    };
...
DataTableHeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [scrollbar_helper_service_1.ScrollbarHelper])
