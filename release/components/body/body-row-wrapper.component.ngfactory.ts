...
import * as import13 from '../../../node_modules/@angular/common/src/directives/ng_template_outlet.ngfactory';
...
class View_DataTableRowWrapperComponent1 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import3.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this.renderer.setElementStyle(this._el_0,'height',((this.viewUtils.sanitizer.sanitize(import12.SecurityContext.STYLE,currVal_7) == null)? (null as any): (this.viewUtils.sanitizer.sanitize(import12.SecurityContext.STYLE,currVal_7).toString() + 'px')));
...
class View_DataTableRowWrapperComponent2 extends import2.AppView<any> {
  ...
  _NgTemplateOutlet_0_6:import13.Wrapper_NgTemplateOutlet;
  _el_1:any;
  _map_5:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import8.ViewContainer) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._NgTemplateOutlet_0_6 = new import13.Wrapper_NgTemplateOutlet(this._vc_0.vcRef);
