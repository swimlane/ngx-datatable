...
import * as import21 from '../../../../src/components/header/header-cell.component';
...
class View_DataTableHeaderComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'datatable-header',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_DataTableHeaderComponent0(this.viewUtils,this,0,this._el_0);
    this._DataTableHeaderComponent_0_3 = new Wrapper_DataTableHeaderComponent(new import9.ElementRef(this._el_0),this.renderer);
    this.compView_0.create(this._DataTableHeaderComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._DataTableHeaderComponent_0_3.context);
  }
...
export class View_DataTableHeaderComponent0 extends import2.AppView<import0.DataTableHeaderComponent> {
  ...
  _query_DraggableDirective_1_0:import11.QueryList<any>;
  _text_2:any;
  _anchor_3:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_DataTableHeaderComponent0,renderType_DataTableHeaderComponent,import7.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckOnce);
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._query_DraggableDirective_1_0 = new import11.QueryList<any>();
...
class View_DataTableHeaderComponent1 extends import2.AppView<any> {
  _el_0:any;
  _NgStyle_0_3:import19.Wrapper_NgStyle;
  _text_1:any;
  _anchor_2:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import12.ViewContainer) {
    super(View_DataTableHeaderComponent1,renderType_DataTableHeaderComponent,import7.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
    this._expr_8 = import1.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),'div',import3.EMPTY_INLINE_ARRAY,(null as any));
    this._NgStyle_0_3 = new import19.Wrapper_NgStyle(this.parentView.parentView.injectorGet(import14.KeyValueDiffers,this.parentView.parentIndex),new import9.ElementRef(this._el_0),this.renderer);
    ...
    this._NgFor_2_6 = new import13.Wrapper_NgFor(this._vc_2.vcRef,this._TemplateRef_2_5,this.parentView.parentView.injectorGet(import16.IterableDiffers,this.parentView.parentIndex),this.parentView.ref);
...
class View_DataTableHeaderComponent2 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import21.DataTableHeaderCellComponent>;
  _DraggableDirective_0_3:import22.Wrapper_DraggableDirective;
  _ResizeableDirective_0_4:import23.Wrapper_ResizeableDirective;
  _LongPressDirective_0_5:import24.Wrapper_LongPressDirective;
  _DataTableHeaderCellComponent_0_6:import25.Wrapper_DataTableHeaderCellComponent;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import12.ViewContainer) {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._DraggableDirective_0_3 = new import22.Wrapper_DraggableDirective(new import9.ElementRef(this._el_0));
    this._ResizeableDirective_0_4 = new import23.Wrapper_ResizeableDirective(new import9.ElementRef(this._el_0));
    this._LongPressDirective_0_5 = new import24.Wrapper_LongPressDirective();
    this._DataTableHeaderCellComponent_0_6 = new import25.Wrapper_DataTableHeaderCellComponent();
    ...
    this._DataTableHeaderCellComponent_0_6.subscribe(this,this.eventHandler(this.handleEvent_0),true);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [
      this._el_0,
      this._text_1
    ]
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import26.DraggableDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._DraggableDirective_0_3.context; }
    if (((token === import27.ResizeableDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ResizeableDirective_0_4.context; }
    if (((token === import28.LongPressDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._LongPressDirective_0_5.context; }
    if (((token === import21.DataTableHeaderCellComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._DataTableHeaderCellComponent_0_6.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
