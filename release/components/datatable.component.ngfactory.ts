...
export class View_DatatableComponent0 extends import2.AppView<import0.DatatableComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_5_0_0:any = this.context.externalPaging;
    this._DataTableBodyComponent_5_3.check_externalPaging(currVal_5_0_0,throwOnChange,false);
    const currVal_5_0_1:any = this.context.scrollbarV;
    this._DataTableBodyComponent_5_3.check_scrollbarV(currVal_5_0_1,throwOnChange,false);
    const currVal_5_0_2:any = this.context.scrollbarH;
    this._DataTableBodyComponent_5_3.check_scrollbarH(currVal_5_0_2,throwOnChange,false);
    const currVal_5_0_3:any = this.context.loadingIndicator;
    this._DataTableBodyComponent_5_3.check_loadingIndicator(currVal_5_0_3,throwOnChange,false);
    const currVal_5_0_4:any = this.context.rowHeight;
    this._DataTableBodyComponent_5_3.check_rowHeight(currVal_5_0_4,throwOnChange,false);
    const currVal_5_0_5:any = this.context.offsetX;
    this._DataTableBodyComponent_5_3.check_offsetX(currVal_5_0_5,throwOnChange,false);
    ...
    const currVal_5_0_10:any = this.context.rowDetail;
    this._DataTableBodyComponent_5_3.check_rowDetail(currVal_5_0_10,throwOnChange,false);
