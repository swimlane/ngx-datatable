...
var DraggableDirective = /** @class */ (function () {
    ...
    DraggableDirective.prototype.onMousedown = function (event) {
        ...
        if (isDragElm && (this.dragX || this.dragY)) {
            ...
            var mouseup = Observable$1.fromEvent(document, 'mouseup');
            this.subscription = mouseup
                .subscribe(function (ev) { return _this.onMouseup(ev); });
            var mouseMoveSub = Observable$1.fromEvent(document, 'mousemove')
                .takeUntil(mouseup)
...
var LongPressDirective = /** @class */ (function () {
    ...
    LongPressDirective.prototype.onMouseDown = function (event) {
        ...
        this.timeout = setTimeout(function () {
            ...
            _this.subscription.add(Observable$1.fromEvent(document, 'mousemove')
                .takeUntil(mouseup)
