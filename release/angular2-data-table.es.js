 ...
 * Licensed under MIT
 */
import { KeyValueDiffers, ElementRef, Component, HostBinding, HostListener, QueryList, ContentChildren, EventEmitter, Output, Input, Injectable, Directive, TemplateRef, ContentChild, ChangeDetectionStrategy, ViewContainerRef } from '@angular/core';
...
function adjustColumnWidths(allColumns, expectedWidth) {
    var columnsWidth = columnTotalWidth$1(allColumns);
