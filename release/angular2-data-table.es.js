...
var DataTableBody = (function () {
    ...
    DataTableBody.prototype.selectRow = function (event, index, row) {
        if (!this.selectEnabled)
            return;
        var multiShift = this.state.getOption(this.key, 'selectionType') === SelectionType.multiShift;
        var multiClick = this.state.getOption(this.key, 'selectionType') === SelectionType.multi;
        var selections = [];
