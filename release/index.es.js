 ...
 * Licensed under MIT
 */
import { NgModule, KeyValueDiffers, ElementRef, Renderer, Host, Component, HostBinding, HostListener, ContentChild, QueryList, ContentChildren, EventEmitter, Output, Input, Directive, TemplateRef, Injectable, ViewChild, ChangeDetectionStrategy } from '@angular/core';
...
var DataTableRowWrapper = (function () {
    ...
    DataTableRowWrapper = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _a) || Object, (typeof (_b = typeof StateService !== 'undefined' && StateService) === 'function' && _b) || Object, (typeof (_c = typeof Renderer !== 'undefined' && Renderer) === 'function' && _c) || Object])
    ], DataTableRowWrapper);
...
export { Angular2DataTableModule, ColumnMode, SortType, SortDirection, SelectionType, ClickType, TableOptions, TableColumn, Sort, DataTable, DataTableColumn, DataTableHeader, DataTableHeaderCell, DataTableBody, DataTableBodyCell, DataTableBodyRow, ProgressBar, DataTableFooter, DataTablePager, DataTableRowWrapper, DatatableRowDetailTemplate };
